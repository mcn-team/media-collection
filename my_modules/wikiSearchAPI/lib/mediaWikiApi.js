...
module.exports = (function() {
    ...
    var mwApi =  function(baseUrl, entryPoint) {
        this.wikiBaseUrl = baseUrl || 'http://fr.wikipedia.org';
        this.entryPoint  = entryPoint || '/w';
    };
    ...
    mwApi.prototype = {
        searchByTitle: function (toSearch, callback) {
            ...
            request(this.wikiBaseUrl + this.entryPoint + '/api.php?action=query&generator=search&gsrsearch=' + toSearch + '&prop=info&inprop=url&format=json', function (error, response, body) {
        ...
        searchInfoById: function (id, dataType, callback) {
            request(this.wikiBaseUrl + this.entryPoint + '/api.php?action=query&prop=revisions&rvprop=content&pageids=' + id + '&rvsection=0&format=json', function (error, response, body) {
                var obj = '*';
